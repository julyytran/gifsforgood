...
Charity.create(name: "The Salvation Army", description: '"Doing The Most Good." In these four words, our mission - to feed, to clothe, to comfort, to care. To rebuild broken homes and broken lives. By walking with the addicted, we can lead them to recovery. In fighting hunger and poverty, we can feed and nurture the spirit.', logo: "https://s3.amazonaws.com/cache.salvationarmy.org/resources/img/ihq-logo.jpg")
